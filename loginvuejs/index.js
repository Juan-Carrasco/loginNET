	...
	var MasterDetail = new Vue({
		...
		methods:{
			...
			makeGetListRequest: function(){
				$.ajax(url="http://localhost:57470/api/Personas",
					method="GET")
			...
			makeGetRequest: function(id){
				$.ajax(url="http://localhost:57470/api/Personas/" + id,
					method="GET")
			...
			makePutRequest: function(item){
				$.ajax({url:"http://localhost:57470/api/Personas/" + item.index,
					method:"PUT",
					data: 	{Id: item.index,
						Nombre: item.name,
			...
			deleteItem: function(index){
				$.ajax({url:"http://localhost:57470/api/Personas/" + index,
					method:"DELETE"})	
				.done(this.makeGetListRequest)
				.fail(function(){
